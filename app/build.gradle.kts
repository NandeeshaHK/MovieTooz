...
dependencies {
    ...
    implementation("androidx.appcompat:appcompat:1.6.1") // Required for Lottie
    implementation("androidx.core:core-splashscreen:1.0.1") // Android 12 Splash
    implementation("androidx.constraintlayout:constraintlayout:2.1.4") // ConstraintLayout
    implementation("com.airbnb.android:lottie:6.2.0") // Lottie Animations
